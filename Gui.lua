...
-- Notification Container Setup (เพิ่มในส่วนตัวแปรเริ่มต้นของ SlayLib:CreateSlayLib)
...
function SectionHandler:Notify(title, message, duration)
    ...
    MessageLabel.Position = UDim2.new(0.02, 0, 0.45, 0)
    ...
    -- Adjust positions slightly to account for the AccentLine
    ...
    -- ก่อนจะทำลาย, ให้ Frame หดตัวลงทันทีเพื่อไม่ให้มีช่องว่าง
